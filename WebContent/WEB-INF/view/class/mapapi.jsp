...
<div id="container">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c212569280ec9ae12c0ad5fa52b00d2c&libraries=services,clusterer,drawing"></script>
	<script>
		...
		var mapCenter = new kakao.maps.LatLng(36.32483582574169 , 127.420078612828), // 지도의 중심좌표
		    mapOption = {
		...
		//주소로 좌표를 검색합니다
		geocoder.addressSearch('대전 중구', function(result, status) {

...
<script>
	$(function(){
		...
		$('#cooknCk').text("*필수항목").css("color", "red");
		...
		//사업자번호 정규식
		$('#cooknum').keyup(function(){
			if(!cooknumcheck()){ return false; }
		})
		...
		$('#joinbtn').on('click',function(){
			if(!regcheck1()){ return false; }
			
			idvalue = $('#id').val().trim();
			$.ajax({
				url : '${pageContext.request.contextPath }/LoginJoin2.do',
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control" id="mails" name="mails">
									...
									<option value="google" selected="selected">gmail.com</option>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="cooknum"
									placeholder="0000000000" name="cooknum">
							</div>
						</div>

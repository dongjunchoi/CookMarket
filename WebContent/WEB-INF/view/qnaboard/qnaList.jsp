            ...
            <div id="sidemenu">
                <div class="sidemenu_content">
                            ...
                            <div class="sidemenu_login_top_info">
                                ...
                                <span class="sidemenu_login_userPoint">사용 가능 포인트: <%=vo.getPoint() %></span>
    ...
    <div class="my_wrapper fnq">
        ...
        <div class="my_fnq_tab">
            ...
            <div class="CustomerCenter_FAQ_kinds">
                <div onclick="location.href='<%=request.getContextPath()%>/qna/qnaList.do'" class='active' >자주묻는질문</div>
...
window.onload = function(){
	...
	qnaAdd.onclick = function(){
		location.href = "<%=request.getContextPath()%>/qna/qnaInsertForm.do";
	};
}
</script>
...
<div class="container">
  ...
  <table class="table">
<thead>
  <tr><td colspan="5"><input type="button" id="qnaAdd" value="등록"></td></tr>
  <tr>
  	<th>COD</th><th>내용</th><th>문의종류</th>
  </tr>
</thead>
<tbody>
	<%
	...
	%>
		 ...
		 <tr class="danger">
			<td><a href="<%=request.getContextPath()%>/qna/qnaView.do?q_cod=<%=URLEncoder.encode(qnaVo.getQ_cod(), "utf-8") %>"><%=qnaVo.getQ_cod() %></a></td>
			<td><%=qnaVo.getQ_content() %></td>
			<td><%=qnaVo.getQq_cod() %></td>
		</tr>	

    ...
    <div class="my_wrapper fnq">
        ...
        <div class="my_fnq_tab">
            ...
            <div class="CustomerCenter_FAQ_kinds">
                <div onclick="location.href='<%=request.getContextPath()%>/qnaboard/Qnaboard.do'"  >자주묻는질문</div>
                <div onclick="location.href='<%=request.getContextPath() %>/notice/noticeList.do'" class='active' >공지사항</div>

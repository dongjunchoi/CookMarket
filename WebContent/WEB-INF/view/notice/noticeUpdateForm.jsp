    ...
    <div class="my_profile_group">
        ...
        <div class="myDamhwa_profile_info">
            ...
            <div class="myDamhwa_profile_info_point">
                <span>사용가능 포인트:</span>
                <span><%=session.getAttribute("point") %></span>
            </div>
        </div>
    </div>
...
<form id="noticeForm" method="post" action="<%=request.getContextPath()%>/notice/noticeUpdate.do">
	...
	<tr>
		<td>내용</td>
		<td>
			<input type="text" name="n_content" id="n_content" value="<%=noticeVo.getN_content() %>">
		</td>
	</tr>
	<tr>
		<td>이름</td>
		<td>
			<input type="text" name="m_name" id="m_name" value="<%=noticeVo.getN_name() %>">
		</td>
	</tr>

            ...
            <div id="nav">
                <div id="nav_content">
                    ...
                    <div class="nav_set">
                        ...
                        <a href="<%=request.getContextPath() %>/class/Classmain.do" class="nav_best">클래스</a>a>
...
div class="my_container">
    <div class="my_wrapper fnq">
      ...
      <!-- 수정부분 세션값으로 공지사항목록 불러오기와 테이블 디자인 -->
...
$(function(){
	...
	$("#btnUpdate").on("click", function(){
		...
		form.action = "<%=request.getContextPath()%>/notice/noticeUpdateForm.do";
	...
	$("#btnDelete").on("click", function(){
		var form = $("#noticeForm").get(0);
		form.action = "<%=request.getContextPath()%>/notice/noticeDelete.do";
		form.submit();  // form의 데이터를 서버로 전송
	});

...
<!-- ~~~~~~~~~~~~~~~~~~~~!!!!!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
					...
					<div class="destination_wrap">
						<div class="deliver_wrap _deliveryInfos _deliveryInfoType" style="width: 787px;">
 ...
 <!-- ~~~~~~~~~~~~~~~~~~~주문자정보~~~~~~~~~~~~~~~~~~~~~~ -->      
					...
					<div class="userinfo_wrap _purchaserInfo" style="width: 260px;">
						<h4>주문자 정보</h4>
						<ul class="user_info">
							<li><%= uservo.getName() %></li>
 ...
 <!-- ~~~~~~~~~~~~~~~~~~~포인트~~~~~~~~~~~~~~~~~~~~~~ -->
				...
				<div class="discount_wrap">
					<div class="discount_info discountPriceInfo" style="width: 786px;">
...
<!-- ~~~~~~~~~~~~~~~~~~~결제~~~~~~~~~~~~~~~~~~~~~~ -->
					...
					<div class="price_sum" style="width: 312px;">
						<h4>포인트 결제금액</h4>
						<div class="sum">
							<strong class="price_sum_title">주문금액</strong>
							<p class="price_sum_detail">
								<em class="_totalPayPrice"><%=request.getAttribute("sum2")%></em>원
							</p>
						</div>
						<ul class="calc_list">
							...
							<li><strong>상품금액</strong>
								<p>
									<em class="_totalOrderPrice"><%=request.getAttribute("sum") %></em>원
								</p></li>
						...
						<div class="calc_list total">
							<strong>합계</strong>
							<p>
								<em class="_totalPriceSum"><%=request.getAttribute("sum2") %></em>원
							</p>
						</div>
						<br>
							<input type="button" class="btn btn-success" value="결제하기" name="결제하기" id="pay" style="width: auto;height: auto;float: right;">
							                   <script>
                   	$(function(){
                   		$('#pay').on('click',function(){
                   			var price = <%=request.getAttribute("sum2")%>;
                   			location.href="<%=request.getContextPath()%>/payment/paygro.do?price=" + price;
                   		})
                   	})
                   </script>
					</div>

   ...
   <br><br>
	...
	<div class="container-fluid text-center">
		...
		<div class="row content">
				...
				<img class="mainimg" src="<%=request.getContextPath() %>/image/<%=oneRecipe.getFilename()%>"  id="<%=oneRecipe.getId()%>" >	
...
<!-- 수정이수정 -->
									...
									if(replyId.equals(sessionId) || "admin".equals(sessionId)){
									%>
 ...
 -->
				...
				if(id2.equals(sessionId) ||  "admin".equals(sessionId) ){
				%>

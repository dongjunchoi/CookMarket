...
<!--                 <label for="cartCheck" class="cart_button" onclick="reTotalPrice('');">
 ...
 -->
        ...
        <!-- PC버전 header end -->
        <!-- 20200420 황선주 수정 확인 -->
        <div id="content" class="dashboard"> </div>
        <div class="pc">
...
$(function(){
	$(function(){
		...
		$("#btnUpdate").on("click", function(){
			...
			form.action = "<%=request.getContextPath()%>/qna/qnaUpdateForm.do";
		...
		$("#btnDelete").on("click", function(){
			var form = $("#qnaForm").get(0);
			form.action = "<%=request.getContextPath()%>/qna/qnaDelete.do";
			form.submit();  // form의 데이터를 서버로 전송
		});
});
</script>

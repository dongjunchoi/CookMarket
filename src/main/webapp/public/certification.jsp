...
$(function(){
	...
	$('#ch').on('click',function(){
		...
		if(a="인증성공"){
			window.close();
			window.open("confirm.jsp","","width=500, height=400");
		}
	})
...
<body>
	<form class="signUp" id="signupForm">
		<h1 class="signUpTitle">인증번호 확인</h1>
		<div>
			<input style="width: 230px; float: left;" type="text" class="signUpInput" id="Certificationbtn_1" 
			name="Certificationbtn_1" placeholder="ex) kls1asd12" autofocus required>
				<span id="cfcheck1"></span>
				<input type="button" class="signUpInput" id="cfbtn" name="cfbtn" value="인증확인"> <br>
				<br>
			<br>
				<input type="button"  class="signUpButton" id="ch" value="확인">
		</div>
	</form>
